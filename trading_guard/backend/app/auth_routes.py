...
from .auth import register, login, google_login, logout, user_id_from_token
...
@router.post("/google")
def google_route(payload:GoogleCredential):
 try: token=google_login(payload.credential)
